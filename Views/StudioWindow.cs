...
internal static class StudioWindow
{
    public static void Style(FrameworkElement host,Panel root)
    {
        ...
        var background=new SolidColorBrush(Color.FromRgb(247,248,245));
        if(host is Control control){control.Background=background;control.FontFamily=new FontFamily("Segoe UI");control.FontSize=13;}
